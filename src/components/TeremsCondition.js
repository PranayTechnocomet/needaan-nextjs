              ...
              <div className="breadcrumb-wrapper">
                <div className="breadcrumb-title-block">
                  ...
                  <div className="home-page-back-link-wrap"><a href="home" className="page-link">Home</a>
                    ...
                    <div className="page-name">Terms & Conditions</div>
                  </div>
                </div>
            ...
            <div className="w-layout-blockcontainer container w-container ">
              ...
              <div className='privecy-policy-content'>
                ...
                <div className='privecy-policy-data-p'>
                  ...
                  <p>If you think you may have a medical emergency, call your doctor or emergency services immediately.
                  </p>
                </div>
              </div>
              <div className='privecy-policy-content'>
                ...
                <div className='privecy-policy-data-p'>
                  <p>You agree not to misuse the Service or help anyone else to do so. You are responsible for your use of the Service and for any decisions you make based on the information provided.</p>
                </div>
              </div>
              <div className='privecy-policy-content'>
